...
const Tracks = (props) => {
    ...
    return (
      <>
        ...
        <div className="flex w-full justify-center items-center h-screen  relative dark:bg-gradient-to-b from-[#191414] to-[#191414] text-white p-10 flex-col bg-white">
          ...
          <div className="py-1 md:px-10 pb-12  dark:bg-gradient-to-b dark:from-[#191414] dark:to-[#191414] to-[#191414] text-black">
  ...
  return !loading ? (
    <>
      <Meta />
      <div
        className={`flex w-full relative bg-gradient-to-b ${props.color} dark:to-[#191414] text-gray-900 dark:text-white md:p-10 flex-col md:flex-row sm:flex-row transition-colors ease-in-out duration-400`}
      >
