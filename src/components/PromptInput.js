  ...
  return (
    <>
      ...
      <textarea
        ...
        className="border border-gray-900 dark:border-white  shadow-xl w-full md:w-96 resize-none outline-none text-gray-900 dark:text-white px-3 py-4 text-sm mt-3 dark:bg-background"
        rows={6}
        value={value}
        type={"text"}
