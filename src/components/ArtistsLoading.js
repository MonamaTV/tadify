...
const ArtistsLoading = () => {
  ...
  return (
    <>
      <Meta />
      <div
        className={`flex w-full relative bg-gradient-to-b dark:to-background text-gray-900 dark:text-white md:p-10 flex-col md:flex-row sm:flex-row transition-colors ease-in-out duration-400  animate-pulse`}
      >
      ...
      <div className="py-1 px-5 md:px-10 pb-12  bg-gradient-to-b dark:from-background dark:to-background to-background animate-pulse">
        <div>
