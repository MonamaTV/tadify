...
const DownloadableArtistsList = ({ data, range = 0, ...props }) => {
  ...
  return (
    <div
      {...props}
      className="flex w-full md:w-[500px]  bg-gradient-to-b to-[#1db954] from-[#191414] text-white p-10 flex-col h-[750px] justify-center pb-24"
    >
      <h2 className="font-bold text-2xl">My Spotify Top Arists</h2>
